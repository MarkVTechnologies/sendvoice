 ...
 * first of an eventual 3–4 templates. Server-rendered, self-contained HTML
 * (system fonts, no external requests) so the same invoice renders
 * identically regardless of what's running the headless browser — PRD
 * §9.2's determinism requirement.
 *
 ...
 */
export function renderClassicTemplate(doc: InvoiceData): string {
